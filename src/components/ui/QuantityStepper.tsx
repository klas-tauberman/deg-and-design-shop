...
export function QuantityStepper({ value, min = 1, max, onChange }: QuantityStepperProps) {
  ...
  return (
    <div className="inline-flex items-center rounded-full bg-[#2F2D2A] text-text-primary text-base font-medium">
      <button
        onClick={() => set(qty - 1)}
        className="size-12 rounded-full flex items-center justify-center transition-colors hover:bg-bg-elevated focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-primary shrink-0"
